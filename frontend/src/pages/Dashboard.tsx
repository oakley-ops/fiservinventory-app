        ...
        <div className="col-md-3">
          <div className="card shadow-sm border-0 rounded-3 h-100">
            <div className="card-body d-flex flex-column">
              ...
              <p className="card-text display-6 mb-0 mt-auto">{dashboardData.totalParts || 0}</p>
            </div>
          </div>
        </div>
        <div className="col-md-3">
          <div className="card shadow-sm border-0 rounded-3 h-100">
            <div className="card-body d-flex flex-column">
              ...
              <p className="card-text display-6 mb-0 mt-auto text-warning">{dashboardData.lowStockParts?.length || 0}</p>
            </div>
          </div>
        </div>
        <div className="col-md-3">
          <div className="card shadow-sm border-0 rounded-3 h-100">
            <div className="card-body d-flex flex-column">
              ...
              <p className="card-text display-6 mb-0 mt-auto text-danger">{dashboardData.outOfStock || 0}</p>
            </div>
          </div>
        </div>
        <div className="col-md-3">
